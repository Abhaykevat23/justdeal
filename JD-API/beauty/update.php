...
$data = json_decode(file_get_contents("php://input"));
    ...
    $fetch_post = "SELECT * FROM `beauty` WHERE id=:id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $beautyname = isset($data->beautyname) ? $data->beautyname : $row['beautyname'];
       ...
       $update_query = "UPDATE `beauty` SET field = :field,image=:image,beautyname=:beautyname,mobile=:mobile,
        ...
        $update_stmt->bindValue(':beautyname', htmlspecialchars(strip_tags($beautyname)), PDO::PARAM_STR);
