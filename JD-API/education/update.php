...
try {
    ...
    $fetch_post = "SELECT * FROM `education` WHERE id=:id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $schoolname = isset($data->schoolname) ? $data->schoolname : $row['schoolname'];
       ...
       $update_query = "UPDATE `education` SET field = :field,image=:image,schoolname=:schoolname,mobile=:mobile,
        ...
        $update_stmt->bindValue(':schoolname', htmlspecialchars(strip_tags($schoolname)), PDO::PARAM_STR);
