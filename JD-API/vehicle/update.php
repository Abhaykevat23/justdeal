...
try {
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $vehiclename = isset($data->vehiclename) ? $data->vehiclename : $row['vehiclename'];
       ...
       $update_query = "UPDATE `doctor` SET field = :field,image=:image,vehiclename=:vehiclename,mobile=:mobile,
        ...
        $update_stmt->bindValue(':vehiclename', htmlspecialchars(strip_tags($vehiclename)), PDO::PARAM_STR);
