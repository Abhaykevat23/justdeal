...
try {
    ...
    $fetch_post = "SELECT * FROM `estate` WHERE id=:id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $estatename = isset($data->estatename) ? $data->estatename : $row['estatename'];
       ...
       $update_query = "UPDATE `estate` SET field = :field,image=:image,estatename=:estatename,mobile=:mobile,
        ...
        $update_stmt->bindValue(':estatename', htmlspecialchars(strip_tags($estatename)), PDO::PARAM_STR);
