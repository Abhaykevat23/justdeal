...
try {
    ...
    $fetch_post = "SELECT * FROM `decoration` WHERE id=:id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $decoratorname = isset($data->decoratorname) ? $data->decoratorname : $row['decoratorname'];
       ...
       $update_query = "UPDATE `decoration` SET image=:image,decoratorname=:decoratorname,mobile=:mobile,
        ...
        $update_stmt->bindValue(':decoratorname', htmlspecialchars(strip_tags($decoratorname)), PDO::PARAM_STR);
